...
@endphp
{{--TODO edit the form for the inventory edit--}}
<div class="modal fade text-left" id="editInventoryModal{{$inventory->inventory_id}}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('update_inventory', $inventory->inventory_id) }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    {{ csrf_field() }}
